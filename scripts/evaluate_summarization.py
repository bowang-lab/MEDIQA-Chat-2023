...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-debug", default=False, action="store_true", help="If true, just runs eval over first example"
    )
    ...
    # NOTE: This has been modified to address: https://github.com/abachaa/MEDIQA-Chat-2023/issues/3
    if args.task == "taskB":
